            ...
            fetch(url + link)
                .then(function (data) {
                    ...
                    var resolveSuccess = function () {
                        resolve('A conexão está OK, exibindo últimas postagens');
                    };
                    ...
                    resolve('Sem conexão. Exibindo postagens offline');
                });

            setTimeout(function () { resolve('Conexão instável. Exibindo postagens offline'); }, 1800);
        });
    }
